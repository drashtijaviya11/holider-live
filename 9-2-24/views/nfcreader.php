...
<div class="container">
	<div class="reg-device-container">
        ...
        <div class="nefdevice-serial <?php echo $this->agent->is_mobile()?'':'text-center'?>" style="display:none"> 
            ...
            <input type="button" value="Submit" class="btn btn-primary <?php echo $this->agent->is_mobile()?'':'mt-2'?>" id="nefdevice_register_btn">
        </div>
...
$(document).ready(function() {
			...
			//return falase;  
                    ...
                    $('#status').text("NDEFReader is not defined or not supported please add device in text area");

...
<form action="https://holider.com/demo/stripe-payment/public/create-checkout-session.php" method="POST" style="text-align: center;">
	...
	<input type="hidden" name="offername" value="<?php echo $offername ?>">
        ...
        <button id="checkout-and-portal-button" type="submit" class="pay-now" style="width: 60% !important;"><?= lang('pay_now'); ?></button>
        <?php }else{?>

	...
	padding: 5px;
        ...
        <div class="v-detail-container">
            ...
            <div class="main-ov">
				...
				<div class="ov-name" style="height:fit-content">
                    <h2>
                ...
                <div class="d-t-sec">
                    <div class="p-date" style="width:50%">
                        <h4 style="min-height: 35px !important;"><?= lang('purch_d_and_t'); ?></h4>
                        <span><?= $voucher['purchase_date'] ?></span>
                    </div>

                    <div class="e-date" style="width:50%;">
                        <h4 style="min-height: 35px !important;line-height:normal"><?= lang('exp_date'); ?></h4>

...
<button onclick="addProvider()" class="btn btn-primary">Add Provider</button>
...
<thead>
  ...
  <?php if(!empty($provider)){
    ...
    <?php $currency_code = $provider_data['default_currency']; ?>
        ...
        <tr class="data-ap" id="<?= $provider_data['id'] ?>">
            ...
            <td><a href="javascript:void(0)" onclick="reedemVoucher(<?= $provider_data['id'] ?>)"><?= getCurrencySymbol($currency_code).$provider_data['redm_vouchers']; ?></a></td>
            <td><a href="javascript:void(0)" onclick="unReedemVoucher(<?= $provider_data['id'] ?>)"><?= getCurrencySymbol($currency_code).$provider_data['unredm_vouchers']; ?></a></td>
            <td><a href="javascript:void(0)" onclick="paidTransaction(<?= $provider_data['id'] ?>)"><?= getCurrencySymbol($currency_code).$provider_data['paid'] ?></a></td>
            <td><a href="javascript:void(0)" onclick="unPaidTransaction(<?= $provider_data['id'] ?>)"><?= getCurrencySymbol($currency_code).$provider_data['unpaid'] ?></a></td>
            <td><?= getCurrencySymbol($currency_code).$provider_data['commission']; ?></td>
            <td><?= getCurrencySymbol($currency_code).$provider_data['aff_comission']; ?></td>
              ...
              <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="providerDropdown" style="position: absolute; left: -100%;";>
                    ...
                    <a href="javascript:void(0)" class="dropdown-item" id="status" class="ee" onclick="activeDeactive(<?= $provider_data['id'] ?>, <?= $provider_data['status'] ?>)">
                        <?php echo ($provider_data['status'] == 1) ? 'Deactivate' : 'Activate'; ?>
                    </a>

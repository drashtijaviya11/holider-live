	...
	<form action="" id="add_about"  method="post" enctype="multipart/form-data">
		<div class="row mt-2">
			<div class="col-4">
				...
				<input type="text" name="heading" class="form-control temp reqre" placeholder="Enter Heading">
			</div>
			<div class="col-4">
				<label for=""><?= lang('our_mission'); ?></label><i class="bi bi-star-fill"></i>
				<input type="text" name="our_mission" class="form-control temp reqre" placeholder="Enter Our Mission">
			</div>
			<div class="col-4">
				<label for=""><?= lang('our_vision'); ?></label><i class="bi bi-star-fill"></i>
				<input type="text" name="our_vision" class="form-control temp reqre" placeholder="Enter Our Vision">
			</div>
		</div>
		<div class="row mt-2">
			<div class="col-4">
				<label for=""><?= lang('our_history'); ?></label><i class="bi bi-star-fill"></i>
				<input type="text" name="our_history" class="form-control temp reqre" placeholder="Our History">
			</div>
			<div class="col-4">

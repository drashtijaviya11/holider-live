...
src="https://www.facebook.com/tr?id=1419132379005520&ev=PageView&noscript=1"
/></noscript>
<style>
	a{
...
.f-Moderno{
  ...
  <?php }else if($this->session->userdata('type')=='admin'){ ?>
	...
	<?php if($this->session->userdata('logged_in')  == TRUE ){?> 
		<a class="dropdown-item text-white" href="<?=base_url();?>dashboard/logout">
  ...
  <!-- <div class="dropdown f-poppins py-2">
   ...
   <div class="dropdown f-poppins py-2">
	...
	<?php  if($this->input->cookie('lang',true)  == 'english'){ ?><img src="<?= base_url() ?>assets/images/U.K..gif" alt="" style="width: 20px;height: 16px;">&nbsp;&nbsp;&nbsp;English 
			...
			<?php }else if($this->input->cookie('lang',true)  == 'french'){ ?> <img src="<?= base_url(); ?>assets/images/france.gif" alt="" style="width: 20px;height: 16px;">&nbsp;&nbsp;&nbsp;French 
    ...
    <ul class="dropdown-menu area_drop btn-bg rounded-0 fs-14 py-0">
		...
		<a class="text language_list" data-language="english" href="javascript:void(0)">
					<img src="<?= base_url() ?>assets/images/U.K..gif" alt="">&nbsp;&nbsp;
					English
				</a>
				<a class="text language_list" data-language="hebrew" href="javascript:void(0)">
				<img src="<?= base_url(); ?>assets/images/Israel.gif" alt="">&nbsp;&nbsp;
					Hebrew
				</a>
					...
					<img src="<?= base_url(); ?>assets/images/france.gif" alt="">&nbsp;&nbsp;
					French
				</a>

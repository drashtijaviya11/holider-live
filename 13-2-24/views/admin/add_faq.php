	...
	<form action="" id="add_faq"  method="post" enctype="multipart/form-data">
		<div class="row mt-2">
			<div class="col-6">
				...
				<input type="text" name="question" class="form-control temp reqre" placeholder="Enter Question">
			</div>
			<div class="col-6">
				<label for="">Answer</label><i class="bi bi-star-fill"></i>
				<input type="text" name="answer" class="form-control temp reqre" placeholder="Enter Answer">
			</div>
		</div>
		<div class="row mt-5">

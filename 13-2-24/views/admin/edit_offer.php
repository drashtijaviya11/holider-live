						...
						<div class="row mt-2">
							...
							<div class="col-4 mt-1">
								...
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" name="refund" id="pickup_yes" value="yes" <?php echo ($offer['refund'] == 'Yes') ? 'checked' : ''; ?>>
									<label class="form-check-label" for="refund_yes"><?= lang('yes'); ?></label>
								</div>
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" name="refund" id="refund_no" value="no" <?php echo ($offer['refund'] == 'No') ? 'checked' : ''; ?>>
							...
							<div class="col-4 mt-1">
								...
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" name="pickup" id="pickup_yes" value="yes" <?php echo ($offer['pickup'] == 'Yes') ? 'checked' : ''; ?>>
									<label class="form-check-label" for="pickup_yes"><?= lang('yes'); ?></label>
								</div>
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" name="pickup" id="pickup_no" value="no" <?php echo ($offer['pickup'] == 'No') ? 'checked' : ''; ?>>

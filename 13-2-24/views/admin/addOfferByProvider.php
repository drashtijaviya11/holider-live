                    ...
                    <form action="" id="add_offer"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-2">
							...
							<label for=""><?= lang('default_currency') ?></label><i class="bi bi-star-fill"></i>
                                <input type="text" name="default_currency" class="form-control temp requre" value="<?= $provider[0]['default_currency']; ?>" readonly>
								<!-- <select name="default_currency" id="currency" class="form-select readonly-select" readonly>
									<?php foreach($currency as $curr) { ?>
										<?php  $selected = ($provider[0]['default_currency'] == $curr['code']) ? 'selected' : ''; ?>
						...
						<div class="row mt-2">
							<div class="col-4 mt-1">
								...
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" name="pickup" id="pickup_yes" value="yes">
									<label class="form-check-label" for="pickup_yes"><?= lang('yes'); ?></label>
								</div>
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" name="pickup" id="pickup_no" value="no">
							...
							<div class="col-4 mt-1">
								...
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" name="refund" id="pickup_yes" value="yes">
									<label class="form-check-label" for="refund_yes"><?= lang('yes'); ?></label>
								</div>
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" name="refund" id="refund_no" value="no">

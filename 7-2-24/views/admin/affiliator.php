...
<div class="temp" style="">
  ...
  <button onclick="addaffiliator()" class="btn btn-primary" style="height: 100%;">Add Affiliator</button>
</div>
        ...
        <tr id="<?= $affiliator_data['id'] ?>">
            ...
            <td><?= $affiliator_data['phone'] ?></td>
						<td style="cursor:pointer;color:">
							<a href="javascript:void(0)" onclick="commissionOffer(<?= $affiliator_data['id'] ?>)" ><?= getCurrencySymbol($affiliator_data['default_currency']).$affiliator_data['affiliatorTotalCommission']  ?></a>	
						</td>
						<td><?= getCurrencySymbol($affiliator_data['default_currency']).$affiliator_data['Paid'] ?></td>
						<td><?= getCurrencySymbol($affiliator_data['default_currency']).$affiliator_data['Unpaid'] ?></td>
            <td>
              <?php

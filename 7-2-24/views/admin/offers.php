...
<div class="temp">
<h2>Offer List</h2>
<a ><button onclick="addOffer()" class="btn btn-primary" style="height: 100%;">Add Offer</button></a>
</div>
...
<thead>
  ...
  <?php if(!empty($offers)){ ?>
  <?php  foreach($offers as $offers_data){?>
        <tr class="data-ap" id="<?= $offers_data['id']  ?>">
            ...
            <td><?= getCurrencySymbol($offers_data['currency_type']).$offers_data['child_price'] ?></td>
            <td><?= getCurrencySymbol($offers_data['currency_type']).$offers_data['child_commission'] ?></td>
            <td><?= getCurrencySymbol($offers_data['currency_type']).$offers_data['child_discount'] ?></td>
            <td><?= getCurrencySymbol($offers_data['currency_type']).$offers_data['adult_price'] ?></td>
            <td><?= getCurrencySymbol($offers_data['currency_type']).$offers_data['adult_commission'] ?></td>
            <td><?= getCurrencySymbol($offers_data['currency_type']).$offers_data['adult_discount'] ?></td>
            <td><?= $offers_data['countOffer'] ?></td>
            <td><?= $offers_data['chld_purchased_offer'] + $offers_data['adlt_purchased_offer'] ?></td>
            <td><?= getCurrencySymbol($offers_data['currency_type']).$offers_data['totalAmount'] ?></td>
            <td>
              <?php
            ...
            <td>
				<a onclick="edit_offer(<?= $offers_data['id'] ?>)" class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
            	<a onclick="openItemTranslationModal(<?= $offers_data['id'] ?>)" class="btn btn-success"><i class="bi bi-translate"></i></a>
			</td>
			<td>
				<div class="dropdown">
				<button class="btn btn-warning dropdown-toggle" type="button" id="providerDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
					<div class="dropdown-menu" aria-labelledby="providerDropdown">
						...
						<a  class="dropdown-item " onclick="viewOfferQr(<?= $offers_data['id'] ?>)">Voucher</a>
                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col-12 d-flex" style="justify-content: space-between; align-items: center;">
                            <div style="font-family: 'Poppins'; font-style: normal; font-weight: 500; font-size: 24px; color: #000000;cousor:pointer">Edit Offer</div>
                    ...
                    <div class="row mx-0">
                                ...
                                foreach ($all_languages as $key => $language) {
                                    ?>
                                        <div class="col-4 d-flex my-2" style="justify-content: space-between; flex-direction: column;">
                                            ...
                                            <div class="input-wrapper">
                                                <label for="" class="translate_language_item_label">Special Offer</label>
                                                <textarea class="form-control shadow-none item_description_txt" name="<?= strtolower($language['language_name']) ?>-item-sp" id="<?= strtolower($language['language_name']) ?>-item-sp" rows="5"></textarea>
                                            </div>
                                        </div>
                                    <?php
                                }
                        ...
                        ?>
                            <div class="col-4 d-flex my-2" style="justify-content: space-between; flex-direction: column;">
                                ...
                                <div class="input-wrapper">
                                    <label for="" class="translate_language_item_label">Special Offer</label>
                                    <textarea class="form-control shadow-none item_description_txt" name="english-item-sp" id="english-item-sp" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-4 d-flex my-2" style="justify-content: space-between; flex-direction: column;">
                                ...
                                <div class="input-wrapper">
                                    <label for="" class="translate_language_item_label">Special Offer</label>
                                    <textarea class="form-control shadow-none item_description_txt" name="dutch-item-sp" id="dutch-item-sp" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-4 d-flex my-2" style="justify-content: space-between; flex-direction: column;">
                                ...
                                <div class="input-wrapper">
                                    <label for="" class="translate_language_item_label">Special Offer</label>
                                    <textarea class="form-control shadow-none item_description_txt" name="french-item-sp" id="french-item-sp" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-4 d-flex my-2" style="justify-content: space-between; flex-direction: column;">
                                ...
                                <div class="input-wrapper">
                                    <label for="" class="translate_language_item_label">Special Offer</label>
                                    <textarea class="form-control shadow-none item_description_txt" name="german-item-sp" id="german-item-sp" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-4 d-flex my-2" style="justify-content: space-between; flex-direction: column;">
                                ...
                                <div class="input-wrapper">
                                    <label for="" class="translate_language_item_label">Special Offer</label>
                                    <textarea class="form-control shadow-none item_description_txt" name="hebrew-item-sp" id="hebrew-item-sp" rows="5"></textarea>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == true) {
                    ...
                    $.each(term, function(key, val) {
                        $('#'+val.title+'-item-term').val(val.trans); 
                    });

                    let sp = data.data.sp;
                    $.each(sp, function(key, val) {
                        $('#'+val.title+'-item-sp').val(val.trans); 
                    });
...
function viewOfferDetail(id)
{
    ...
    /**********Loader**************/
    $.ajax({
            url : "<?= base_url('admin/viewOfferDetali_ajaxRequest'); ?>",
            type : "POST",
            data : {id:id},
            dataType : "json",
            success : function(res)
    ...
    function viewOfferQr(id)
    {
        ...
        /**********Loader**************/
        $.ajax({
            url : "<?= base_url('admin/viewOfferQr') ?>",
            data : {id:id},
            dataType : "json",
            type : "POST",
            success : function(res){
    ...
    var rowCount = $("#offerTable tbody tr").length;

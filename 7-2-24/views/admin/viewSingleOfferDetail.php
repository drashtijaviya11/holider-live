  ...
  <?php if(!empty($offers)){
    foreach($offers as $offers_data){?>
        <tr class="data-ap" id="<?= $offers_data['id']  ?>">
            ...
            <td><?= get_price($offers_data['child_price']) ?></td>
            <td><?= get_price($offers_data['child_commission']) ?></td>
            <td><?= get_price($offers_data['child_discount']) ?></td>
            <td><?= get_price($offers_data['adult_price']) ?></td>
            <td><?= get_price($offers_data['adult_commission']) ?></td>
            <td><?= get_price($offers_data['adult_discount']) ?></td>

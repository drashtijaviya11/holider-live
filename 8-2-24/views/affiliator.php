<style>
 ...
 #closeButton{
    ...
    margin-top: calc(10*var(--aspect-ratio));
    display: flex;
    gap: calc(6*var(--aspect-ratio));
    overflow-x: scroll;
...
<?php
    ...
    <div class="main-section">
        ...
        <div class="th-buttons">
            ...
            <div class="nefdevice-serial" style="width: 90%;margin: 0 auto;margin-top: 6%;display:none;"> 
                    <textarea id="nefdevice-serial" name="nefdevice-serial" rows="4" cols="44" style="width: 100%;">
                    </textarea>
            ...
            <div class="gen-list">
                <button class="gen1">
                    ...
                    echo get_currency($totalCommission,$default_currency);//getCurrencySymbol($currency_code).$totalCommission;// = (number_format($totalCommission->amount, 2));
                    //echo get_currency($formattedNumber,$default_currency); 
                    }else{
                        echo 0;   
                    }
                    ?></span>
                ...
                <table class="af-li-item">
					<thead>
						<tr class="af-list">
							...
							<th class="al-item4" style="width: 15%;"><?php echo lang('commission percent')?></th>
						</tr>
					</thead>
...
var offset = 0;
    ...
    isLoading = true;
		$.ajax({
            url: '<?= base_url('affiliator/getAffiliatorCommission') ?>/',
			data : {offset:offset},
            type: 'POST',
            dataType: 'json',
            success: function(data) {
				if(data.affiliatorCommissionList.length > 0){
					console.log(data.html);
					$('.list_section').append(data.html);
					offset += data.affiliatorCommissionList.length;
					isLoading = false;
				}
            }
        });

...
<body>
    <div class="main-contain" style="background-color: #f6f6f6; width: 100%; height: 100vh; ; flex-direction: column; align-items: center; padding-top: 40px;">
        <div class="c-pass-table" style="background-color: #fff; border-radius: 4px;flex-direction: column; padding: 3% 2%;">
                ...
                <div class="detail-table" style="width: 100%; height: auto; margin-top: 1%; padding: 0%;">
                    <table class="detail-data" style="width: 100%;">
                        ...
                        <!-- <tr class="list" style="width: 100%; height: 1.5rem;">
                            ...
                            <td class="l-item" width="20%" style= "color:#474747; font-family: Rubik ,sans-serif; font-weight: 400; font-size: 15px;"><?php echo $pickupdate; ?></td>
                        </tr> -->
                        <!-- <tr class="list" style="width: 100%; height: 1.5rem;">
                            <td class="l-item" width="30%" style= "color:#474747; font-family: Rubik ,sans-serif; font-weight: 400; font-size: 15px;"><?= lang('hour') ?>:</td>
                            <td class="l-item" width="20%" style= "color:#474747; font-family: Rubik ,sans-serif; font-weight: 400; font-size: 15px;"><?php echo $hour; ?><?= lang('hour') ?> <?php echo $minute; ?><?= lang('minutes') ?></td>
                        </tr> -->
                    </table>
                </div>
            ...
            <div class="last" style="width: 100%; flex-direction: row; align-items: flex-end; justify-content: space-between;margin:auto;text-align: center;">

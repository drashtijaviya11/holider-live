...
<form action="https://holider.com/demo/stripe-payment/public/create-checkout-session.php" method="POST">
	...
	<input type="hidden" name="offername" value="<?php echo $offername ?>">
        ...
        <button id="checkout-and-portal-button" type="submit" class="pay-now"><?= lang('pay_now'); ?></button>
        <?php }else{?>
            <button id="checkout-and-portal-button" type="submit" class="pay-now" disabled><?= lang('pay_now'); ?></button>
        <?php } ?>

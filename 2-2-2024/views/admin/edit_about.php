	...
	<form action="" id="update_about"  method="post" enctype="multipart/form-data">
		<div class="row mt-2">
			<div class="col-4">
				...
				<input type="text" name="heading" class="form-control temp reqre" placeholder="<?= lang('enter_heading') ?>" value="<?= $about_us['heading'] ?>">
			</div>
			<div class="col-4">
				<label for=""><?= lang('our_mission'); ?></label><i class="bi bi-star-fill"></i>
				<input type="text" name="our_mission" class="form-control temp reqre" placeholder="<?= lang('enter_our_mission') ?>" value="<?= $about_us['our_mission'] ?>">
			</div>
			<div class="col-4">
				<label for=""><?= lang('our_vesion'); ?></label><i class="bi bi-star-fill"></i>
				<input type="text" name="our_vision" class="form-control temp reqre" placeholder="<?= lang('enter_our_vesion') ?>" value="<?= $about_us['our_vision'] ?>">
			</div>
		</div>
		<div class="row mt-2">
			<div class="col-4">
				<label for=""><?= lang('our_history'); ?></label><i class="bi bi-star-fill"></i>
				<input type="text" name="our_history" class="form-control temp reqre" placeholder="<?= lang('enter_our_history') ?>" value="<?= $about_us['our_history'] ?>">
			</div>

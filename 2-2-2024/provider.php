...
<button onclick="addProvider()" class="btn btn-primary" style="height: 40px;">Add Provider</button>
        ...
        <tr class="data-ap" id="<?= $provider_data['id'] ?>">
            ...
            <td>
              <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="providerDropdown" style="position: relative;">
                    <a class="dropdown-item" onclick="edit_provider(<?= $provider_data['id'] ?>)" >Edit</a>
                    <a class="dropdown-item" id="status" class="ee" onclick="activeDeactive(<?= $provider_data['id'] ?>, <?= $provider_data['status'] ?>)">
                        <?php echo ($provider_data['status'] == 1) ? 'Deactive' : 'Active'; ?>
                    </a>
                    <a class="dropdown-item" onclick="providerOfferVoucher(<?= $provider_data['id']; ?>)">Vouchers</a>
